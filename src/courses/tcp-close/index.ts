...
export default {
  ...
  concepts: [
    ...
    },
    {
      ...
      relatedConcepts: ['retransmission', 'socket'],
    },
  ],
  challenge: {
    ...
    answer: 'b',
    explanation:
      '此时 Client 在 FIN_WAIT_2 等待对方 FIN，仍可接收 Server 的剩余数据。Server 应用完成发送后才关闭自己的方向。',
