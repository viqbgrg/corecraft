...
export default {
  ...
  prerequisites: ['memory', 'process', 'cache'],
  nextConcepts: ['page-cache', 'buffer-pool'],
  concepts: [
    {
      id: 'virtual-memory',
      title: '虚拟内存',
    ...
    },
    {
      ...
      relatedConcepts: ['tlb', 'page-fault'],
    },
    {
      id: 'tlb',
      title: 'TLB',
    ...
    },
    {
      ...
      relatedConcepts: ['virtual-memory', 'page-cache'],
    },
  ],
  challenge: {
